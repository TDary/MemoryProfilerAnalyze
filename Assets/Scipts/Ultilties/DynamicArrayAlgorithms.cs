...
namespace Scipts.Ultilties
{
    namespace Unsafe
    {
        internal static class DynamicArrayAlgorithms
        {
            ...
            // /// </list>
            // /// </returns>
            // public static long BinarySearch(MemorySnapshot.ISortedEntriesCache array, ulong value)
            // {
            //     if (array.Count == 0)
            //         return ~0;
            //
                ...
                where TComparer : unmanaged
            {
                ...
                // /// or <see cref="MemorySnapshot.ManagedMemorySectionEntriesCache.SortIndexHelper"/>.
