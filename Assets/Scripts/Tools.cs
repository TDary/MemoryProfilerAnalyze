...
namespace DefaultNamespace
{
    ...
    {
        public static void SendMessage(string RobotUrl,string msg)
        {
            var markdown = new {text = msg};
            var data = new { msgtype = "markdown", markdown };
            SendPostJson(RobotUrl, JsonMapper.ToJson(data));
        }
