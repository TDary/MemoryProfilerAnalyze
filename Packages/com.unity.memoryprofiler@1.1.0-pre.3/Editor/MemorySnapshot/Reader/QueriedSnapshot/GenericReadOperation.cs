...
namespace Unity.MemoryProfiler.Editor.Format.QueriedSnapshot
{
    ...
    public unsafe class GenericReadOperation : CustomYieldInstruction, IGenericReadOperation
    {
    ...
    public unsafe class NestedDynamicSizedArrayReadOperation<T> : CustomYieldInstruction, IGenericReadOperation where T : unmanaged
    {
        bool m_DoneReading;
