...
namespace Unity.MemoryProfiler.Editor.UI
{
    class MemoryMapBreakdownViewController : TreeViewController<MemoryMapBreakdownModel, MemoryMapBreakdownModel.ItemData>, IViewControllerWithVisibilityEvents
    {
        ...
        protected override void OnMenuItemSelected(int itemId, MemoryMapBreakdownModel.ItemData itemData, TreeViewItemData<MemoryMapBreakdownModel.ItemData> selectedItems)
        {
            // TO IMPLEMENT
        }
