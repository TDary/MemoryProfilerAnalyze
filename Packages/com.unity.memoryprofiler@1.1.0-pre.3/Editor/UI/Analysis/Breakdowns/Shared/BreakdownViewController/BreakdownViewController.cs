...
namespace Unity.MemoryProfiler.Editor.UI
{
    ...
    abstract class BreakdownViewController : ViewController
    {
        ...
        {
            ( "Export All Of Memory", AllTrackedMemoryTableMode.OnExportAllOfMemory, (x) => true ),
            ( "Export All Unity Objetcs", AllTrackedMemoryTableMode.OnExportAllUnityObject, (x) => true ),
            ( "Export Selected TreeItemData", AllTrackedMemoryTableMode.OnlyExport, (x) => true ),
        ...
        public AllTrackedMemoryTableMode TableColumnsMode
        {
            ...
            set
            {
                if (value != AllTrackedMemoryTableMode.OnlyExport && value != AllTrackedMemoryTableMode.OnExportAllUnityObject && 
                    value != AllTrackedMemoryTableMode.OnExportAllOfMemory && m_TableColumnsMode == value)
                    return;
        ...
        void OnBreakdownModeDropdown(ChangeEvent<string> evt)
        {
            ...
            var mode = k_BreakdownModes[newModeIndex].mode;
