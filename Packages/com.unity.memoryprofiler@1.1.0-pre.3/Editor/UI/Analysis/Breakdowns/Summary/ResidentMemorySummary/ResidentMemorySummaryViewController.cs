...
namespace Unity.MemoryProfiler.Editor.UI
{
    internal class ResidentMemorySummaryViewController : ViewController, IMemorySummaryViewController
    {
        ...
        public MemorySummaryModel Model
        {
            get
            {
                return m_Model;
        ...
        #region 增加数据导出按钮
        private const string k_UxmlHeaderExportButton = "memory-summary__header__export-button";
        Button m_ExportSummaryBtn;
        public Action ExportSummaryAction { get; set; }
        ...
        void GatherViewReferences()
        {
            ...
            m_ExportSummaryBtn = View.Q<Button>(k_UxmlHeaderExportButton);
        ...
        void RefreshView()
        {
            ...
            UIElementsHelper.SetVisibility(m_ExportSummaryBtn, true);

            m_ExportSummaryBtn.clicked += () => { ExportSummaryAction?.Invoke(); };
